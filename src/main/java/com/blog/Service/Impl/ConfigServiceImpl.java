...
public class ConfigServiceImpl implements ConfigService {
    ...
    public static final String websiteName = "个人博客";
    public static final String websiteDescription = "本个人博客是SpringBoot2+Thymeleaf+Mybatis搭建";
    ...
    public static final String yourEmail = "185810175@qq.com";
    public static final String yourName = "向优";

    public static final String footerAbout = "your personal blog. have fun.";
    public static final String footerICP = "";
    public static final String footerCopyRight = "@2019 向优、姚培";
